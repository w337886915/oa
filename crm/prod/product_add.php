...
<a href="admin.php?ac=<?php echo $ac;?>&fileurl=<?php echo $fileurl;?>&do=add" class="active"><span><img src="template/default/content/images/p2.gif" width="16" height="16" align="absmiddle">产品添加</span></a>
</div>
...
<tr>
	...
	<tr>
      ...
      <td class="TableData"><input name="price" type="text" class="BigInput" id="price" size="40" style="width: 100px;" onKeyUp="value=value.replace(/[^0-9^.]/g,'');" />/元  非中文，如填写格式"2.68"</td>
      <td class="TableContent">产品分类：<? get_helps()?></td>
      <td class="TableData"><select class="SelectStyle" name="type">
										<option value="" >请选择分类</option>
										<?php prod_type(0,0,0,0)?>
										</select> 
      </td>
    </tr>
</table>
<?php
//引入表单
form_add('产品信息','crm_product');
//引入编辑器
form_add_eweb('crm_product');
?>
