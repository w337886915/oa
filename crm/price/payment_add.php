...
<?
global $db;
$query = $db->query("SELECT * FROM ".DB_TABLEPRE."crm_form where type1='crm_payment' or type1='crm_contact'  ORDER BY inputnumber Asc");
...
<a href="admin.php?ac=<?php echo $ac;?>&fileurl=<?php echo $fileurl;?>" ><span><img src="template/default/content/images/p3.gif" width="16" height="16" align="absmiddle">付款信息</span></a>
<a href="admin.php?ac=<?php echo $ac;?>&fileurl=<?php echo $fileurl;?>&do=add" class="active"><span><img src="template/default/content/images/p2.gif" width="16" height="16" align="absmiddle">付款添加</span></a>
</div>
...
<tr>
	...
	<tr>
      ...
      <td class="TableContent" width="15%"> 付款名称：<? get_helps()?></td>
