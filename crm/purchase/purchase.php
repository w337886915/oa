...
<table width="98%" border="0" align="center" cellpadding="3" cellspacing="0" class="small">
  <tr>
    <td class="Big"><img src="template/default/content/images/notify_new.gif" align="absmiddle"><span class="big3"> 采购信息列表</span>
	<span style="font-size:12px; float:right; margin-right:20px;"><input type="button" value="新增采购" class="BigButtonBHover" onClick="javascript:window.location='admin.php?ac=<?php echo $ac;?>&do=add&fileurl=<?php echo $fileurl;?>'">
	</span>
    </td>
  </tr>
</table>
				...
				<div class="record-search-time fn-clear">
					...
					<label class="ui-form-label" for="keyword">流水号：</label>
						...
						<div id="J-set-date" class="quick-link-date  blue-links  ">
							...
							<a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&ischeck=1&ui=<?php echo $ui?>&un=<?php echo $un?>" seed="CR-today" id="J-today" >今天</a>
							<a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&ischeck=2&ui=<?php echo $ui?>&un=<?php echo $un?>" seed="CR-sevenday" id="J-seven-day">3天以内</a>
							<a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&ischeck=3&ui=<?php echo $ui?>&un=<?php echo $un?>" seed="CR-month" id="J-a-month" >7天以内</a>
							<a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&ischeck=4&ui=<?php echo $ui?>&un=<?php echo $un?>" seed="CR-month" id="J-a-month" >1个月内</a>
							<a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&ischeck=5&ui=<?php echo $ui?>&un=<?php echo $un?>" seed="CR-month" id="J-a-month" >6个月内</a>
						</div>
					</div>
...
<label class="ui-form-label" for="keyword">采购名称：</label>
							<div id="J-keyword-type-select" class="ui-form-select-shell">
...
<?php foreach ($result as $row) {?>
	...
	?></td>
	  ...
	  <?php form_list_view('crm_purchase',$row['id']);?>
      <td align="center" class="TableData">
      <span style="font-size:18px; color:#FF0000; font-weight:900;">
	  <?php echo number_format($row['pricenum'],2,'.',',');?></span></td>
      <td align="center" class="TableData">
	  ...
	  <a href="admin.php?ac=<?php echo $ac;?>&fileurl=<?php echo $fileurl;?>&do=view&id=<?php echo $row['id']?>">查看</a> | <a href="admin.php?ac=<?php echo $ac;?>&fileurl=<?php echo $fileurl;?>&do=edit&id=<?php echo $row['id']?>">编辑</a></td>
    </tr>
