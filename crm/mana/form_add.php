...
<table class="TableBlock" border="0" width="70%" align="center">
 ...
 <tbody width="90%" id="div2">
	...
	<tr>
      ...
      <td class="TableData">
	  <input name="type2" type="radio" value="1"  />
	  是
      <input name="type2" type="radio" value="0" checked="checked" />否
	...
	<tr>
      ...
      <td class="TableData">
      宽:<input type="text" name="w" class="BigInput" style="width:40px;" onKeyUp="value=value.replace(/[^0-9]/g,'');"/>px;&nbsp;&nbsp;&nbsp;&nbsp;高:<input type="text" name="h" class="BigInput" style="width:40px;" onKeyUp="value=value.replace(/[^0-9]/g,'');"/>px;
	  </td>
    </tr>
