...
<?
global $db;
$query = $db->query("SELECT * FROM ".DB_TABLEPRE."crm_form where type1='crm_company' or type1='crm_contact'  ORDER BY inputnumber Asc");
...
<a href="admin.php?ac=<?php echo $ac;?>&fileurl=<?php echo $fileurl;?>" ><span><img src="template/default/content/images/p3.gif" width="16" height="16" align="absmiddle">客户信息</span></a>
<a href="admin.php?ac=<?php echo $ac;?>&fileurl=<?php echo $fileurl;?>&do=add" class="active"><span><img src="template/default/content/images/p2.gif" width="16" height="16" align="absmiddle">客户添加</span></a>
</div>
...
<?php
//引入表单
form_add('客户信息','crm_company');
//引入编辑器
form_add_eweb('crm_company');
?>
...
<tr>
	...
	<tr>
      <td nowrap class="TableContent" width="15%"> 
        姓名：<? get_helps()?></td>
      <td class="TableData" width="35%"><input name="name" type="text" class="BigInput" id="name" style="width: 200px;" value="" maxlength="100" /></td>
