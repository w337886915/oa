...
<table width="98%" border="0" align="center" cellpadding="3" cellspacing="0" class="small">
  <tr>
    <td class="Big"><img src="template/default/content/images/notify_new.gif" align="absmiddle"><span class="big3"> 客户关怀信息列表</span>
...
<?php foreach ($result as $row) {?>
	...
	?></td>
	  ...
	  <?php form_list_view('crm_care',$row['id']);?>
