...
<table width="98%" border="0" align="center" cellpadding="3" cellspacing="0" class="small">
  <tr>
    <td class="Big"><img src="template/default/content/images/notify_new.gif" align="absmiddle"><span class="big3"> 客户投诉信息列表</span>
...
<label class="ui-form-label" for="keyword">主题：</label>
							<div id="J-keyword-type-select" class="ui-form-select-shell">
...
<?php foreach ($result as $row) {?>
	...
	?></td>
      ...
      <td align="left" class="TableData"><a href="admin.php?ac=<?php echo $ac;?>&fileurl=<?php echo $fileurl;?>&do=view&id=<?php echo $row['id']?>&type=<?php echo $row['type']?>&cid=<?php echo $row['cid']?>"><?php echo $row['title']?></a></td>
      
	  <?php form_list_view('crm_complaints',$row['id']);?>
	  <td align="center" class="TableData">
      <?php echo $row['comdate']?></td>
	  <td align="center" class="TableData">
