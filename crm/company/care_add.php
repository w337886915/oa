...
<a href="admin.php?ac=<?php echo $ac;?>&fileurl=<?php echo $fileurl;?>" ><span><img src="template/default/content/images/p3.gif" width="16" height="16" align="absmiddle">客户关怀信息</span></a>
<a href="admin.php?ac=<?php echo $ac;?>&fileurl=<?php echo $fileurl;?>&do=add" class="active"><span><img src="template/default/content/images/p2.gif" width="16" height="16" align="absmiddle">客户关怀添加</span></a>
</div>
...
<tr>
	...
	<tr>
      <td nowrap class="TableContent" width="15%"> 
        流水号：<? get_helps()?></td>
      <td class="TableData" width="35%"><input name="number" type="text" class="BigInput" id="number" style="width: 300px;" value="T<?php echo get_date('YmdHis',PHP_TIME)?>"/></td>
	...
	<!--<tr>
	  ...
	  <td class="TableContent" width="15%"> 提醒方式：</td>
      <td class="TableData" width="35%">
...
<?php
//引入表单
form_add('客户关怀信息','crm_care');
//引入编辑器
form_add_eweb('crm_care');
?>
