...
<table width="98%" border="0" align="center" cellpadding="3" cellspacing="0" class="small">
  <tr>
    <td class="Big"><img src="template/default/content/images/notify_new.gif" align="absmiddle"><span class="big3"> 解决方案信息列表</span>
...
<?php foreach ($result as $row) {?>
	...
	?></td>
	  ...
	  <?php form_list_view('crm_program',$row['id']);?>
	  ...
	  <?php
if($_flow==1){
    crm_flow1($row['id'],'crm_program');
}
?>
      <td align="center" class="TableData">
	  <?php 
if($_flow==1){
    crm_flow2($row['id'],'crm_program',$fileurl);
}
?>
