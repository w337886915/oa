...
<a href="admin.php?ac=<?php echo $ac;?>&fileurl=<?php echo $fileurl;?>" ><span><img src="template/default/content/images/p3.gif" width="16" height="16" align="absmiddle">合同信息</span></a>
<a href="admin.php?ac=<?php echo $ac;?>&fileurl=<?php echo $fileurl;?>&do=add" class="active"><span><img src="template/default/content/images/p2.gif" width="16" height="16" align="absmiddle">合同添加</span></a>
</div>
...
<tr>
	...
	<tr>
      ...
      <td class="TableData" width="15%" align="center"><input name="price_<?php echo trim($row['id']);?>" type="text" class="BigInput" id="price_<?php echo trim($row['id']);?>" style="width: 100px;" value="<?php echo trim($row['price']);?>" onKeyUp="value=value.replace(/[^0-9^.]/g,'');" /></td>
      <td class="TableData" width="15%" align="center"><input name="number_<?php echo $row['id'];?>" type="text" class="BigInput" id="number_<?php echo $row['id'];?>" style="width: 100px;" onKeyUp="value=value.replace(/[^0-9]/g,'');" /></td>
...
<?php
//引入表单
form_add('合同信息','crm_contract');
//引入编辑器
form_add_eweb('crm_contract');
//引入流程
if($_flow==1){
	crm_flow_add('crm_contract');
}
?>
