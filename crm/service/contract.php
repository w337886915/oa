...
<table width="98%" border="0" align="center" cellpadding="3" cellspacing="0" class="small">
  <tr>
    <td class="Big"><img src="template/default/content/images/notify_new.gif" align="absmiddle"><span class="big3"> 合同信息列表</span>
...
<label class="ui-form-label" for="keyword">合同名称：</label>
							<div id="J-keyword-type-select" class="ui-form-select-shell">
...
<?php foreach ($result as $row) {?>
	...
	?></td>
	  ...
	  <?php form_list_view('crm_contract',$row['id']);?>
	  <td class="TableData" align="center" style="font-size:18px; color:#FF0000; font-weight:900;"><?php echo $row['price']?></td>
	  ...
	  <?php
if($_flow==1){
    crm_flow1($row['id'],'crm_contract');
}
?>
      <td align="center" class="TableData">
	  <?php 
if($_flow==1){
    crm_flow2($row['id'],'crm_contract',$fileurl);
}
?>
