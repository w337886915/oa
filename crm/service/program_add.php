...
<a href="admin.php?ac=<?php echo $ac;?>&fileurl=<?php echo $fileurl;?>" ><span><img src="template/default/content/images/p3.gif" width="16" height="16" align="absmiddle">解决方案信息</span></a>
<a href="admin.php?ac=<?php echo $ac;?>&fileurl=<?php echo $fileurl;?>&do=add" class="active"><span><img src="template/default/content/images/p2.gif" width="16" height="16" align="absmiddle">解决方案添加</span></a>
</div>
...
<?php
//引入表单
form_add('解决方案信息','crm_program');
//引入编辑器
form_add_eweb('crm_program');
//引入流程
if($_flow==1){
	crm_flow_add('crm_program');
}
?>
