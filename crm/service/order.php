...
<table width="98%" border="0" align="center" cellpadding="3" cellspacing="0" class="small">
  <tr>
    <td class="Big"><img src="template/default/content/images/notify_new.gif" align="absmiddle"><span class="big3"> 订单信息列表</span>
...
<label class="ui-form-label" for="keyword">订单名称：</label>
							<div id="J-keyword-type-select" class="ui-form-select-shell">
...
<?php foreach ($result as $row) {?>
	...
	?></td>
	  ...
	  <?php form_list_view('crm_order',$row['id']);?>
	  <td class="TableData" align="center"><?php echo $row['price']?></td>
	  ...
	  <?php
		if($_flow==1){
			crm_flow1($row['id'],'crm_order');
		}
		?>
      <td align="center" class="TableData">
	  <?php 
		if($_flow==1){
			crm_flow2($row['id'],'crm_order',$fileurl);
		}
		?>
