...
<div class="container" id="cpcontainer"><div class="itemtitle"><h3>岗位设置</h3></div>
...
var rowtypedata = [
	[[1, ''], [1,'', 'td25'], [5, '<div><input name="newname[]" value="顶级岗位名称" size="20" type="text" class="txt" /><input type="hidden" name="newid[]" value="1" /><a href="javascript:;" class="deleterow" onClick="deleterow(this)">删除</a></div>']],
	[[1, ''], [1,'', 'td25'], [5, '<div class="board"><input name="newname[]" value="岗位名称" size="20" type="text" class="txt" /><input type="hidden" name="newids[]" value="2" /><a href="javascript:;" class="deleterow" onClick="deleterow(this)">删除</a><select name="newinherited[]"><option value="">指定上级岗位</option>' + forumselect + '</select></div>']],
	[[1, ''], [1,'', 'td25'], [5, '<div class="board"><input name="newname[]" value="岗位名称" size="20" type="text" class="txt" /><input type="hidden" name="newids[]" value="2" /><a href="javascript:;" class="deleterow" onClick="deleterow(this)">删除</a><select name="newinherited[]"><option value="">指定上级岗位</option>' + forumselect + '</select></div>']],
];
</script>
