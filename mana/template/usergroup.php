...
<div id="content" class="ui-content fn-clear" coor="default" coor-rate="0.02">
	...
	<form name="update" method="post" action="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>">
        <tr>
            ...
            <td width="9%" align="right" style="padding-right:10px;"><input type="button" value="新增账号" class="BigButtonBHover" onclick="javascript:window.location='admin.php?ac=usergroup&amp;fileurl=mana&amp;do=add'"></td>
        </tr>
