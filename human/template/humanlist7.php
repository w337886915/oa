...
<table  class="table table-bordered table-hover" width="100%">
      ...
      <td width="100">流水号</td>
								<td width="100">调动人员</td>
									<td width="100">调动类型</td>
									<td width="100">调动日期</td>
									<td width="120">调动生效日期</td>
									<td width="100">调动前职务</td>
...
<td><?php echo get_human_db($row['id'],"toa_7_TRANSFER_TYPE")?></td>
<td><?php echo get_human_db($row['id'],"toa_7_TRANSFER_DATE")?></td>
<td><?php echo get_human_db($row['id'],"toa_7_TRANSFER_EFFECTIVE_DATE")?></td>
<td><?php echo get_human_db($row['id'],"toa_7_TRAN_POSITION_BEFORE")?></td>
