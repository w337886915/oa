...
<div class="tabbable work-nav"> <!-- Only required for left/right tabs -->
				<ul id="myTab" class="nav nav-tabs">
					<li><a href="admin.php?ac=seal&fileurl=member" data-toggle="tab">印鉴管理</a></li>
					<li class="active"><a href="admin.php?ac=hongtou&fileurl=member" data-toggle="tab">红头文件管理</a></li>
				</ul>
			</div>
...
<div class="data-wrap">
	<div class="data-operation">
		...
		<button type="button" action="new_work" class="btn btn-success" onClick="javascript:window.location='admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&do=add'">上传红头文件</button>				
