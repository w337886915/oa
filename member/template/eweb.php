...
<div id="content" class="ui-content fn-clear" coor="default" coor-rate="0.02">
	<div class="ui-grid-21" coor="content">
		<div class="ui-grid-21 ui-grid-right record-tit" coor="title">
			<h2 class="ui-tit-page">收藏信息列表</h2>
			
			<div class="record-tit-amount">
				<p>总共有<span class="number"><?php echo public_number('web')?></span>条数据
              </p>
			</div>
		</div>
		...
		<div class="ui-grid-21 ui-grid-right fn-clear" coor="total">
		                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                          <tr>
                                            ...
                                            <td width="9%" align="right" style="padding-right:10px;"><input type="button" value="新增信息" class="BigButtonBHover" onClick="javascript:window.location='admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&do=add'"></td>
                                          </tr>
                                        </table>
...
<td class="title">
<a href="<?php echo $row['weburl']?>" target="_blank" ><?php echo $row['title']?></a>
</td>
<td class="name"><a href="<?php echo $row['weburl']?>" target="_blank" ><?php echo $row['weburl']?></a></td>
